...
<div class="container align-items-start ">
    <form action="{{ route('admin.publish_post') }}" method="post">
    @csrf
        ...
        <input type="hidden" id="selectedOption" name="genre" />
        <div class="col-3 mt-5">
            <h4>Date Published</h4>
            <input class="form-control" type="text" placeholder="Date Published" name="date_published" />
        </div>
