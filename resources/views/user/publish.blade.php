...
<div class="container align-items-start ">
    <form action="{{ route('user.publish_post') }}" method="post">
    @csrf
        ...
        <input type="text" id="selectedOption" name="genre" readonly/>
        <div class="col-3 mt-5">
            <h4>Date of Request</h4>
            <input class="form-control" type="text" placeholder="Date Of Request" name="date_of_request" />
        </div>
        <div class="col-12 mt-5">
            <h4>Description</h4>
            <input class="form-control" type="text" placeholder="Tell something about the story" name="description" />
        </div>
        <div class="col-3 mt-5">
